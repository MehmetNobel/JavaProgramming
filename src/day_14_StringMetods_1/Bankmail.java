...
public class Bankmail {
    ...
    public static void main(String[] args) {
        ...
        String emailBeforeAt=email.substring(0,1);

        //mike.smith@example.com

        boolean dot=email.substring(email.indexOf("@")).contains(".");

        if (email.contains(".")&&email.contains("@")&&!emailBeforeAt.equals("@")&&dot) {
